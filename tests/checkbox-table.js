...
import CheckboxTable from "@phlax/react-checkbox-table/checkbox-table";
...
test("CheckboxTable render", () => {
    ...
    // hmm - code should not be hardcoded
...
test.skip("CheckboxTable renderSelectAllCheckbox", () => {
...
test("CheckboxTable handleSelectAll", () => {
    ...
    table.instance().handleSelectAll(e);
...
test("CheckboxTable handleCheckboxClick", () => {
    ...
    expect(evt.stopPropagation.mock.calls).toEqual([[]]);
